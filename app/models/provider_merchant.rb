class ProviderMerchant < Merchant
  enum :source, { plaid: "plaid", simplefin: "simplefin", lunchflow: "lunchflow", synth: "synth", ai: "ai", enable_banking: "enable_banking", bridge: "bridge", coinstats: "coinstats", mercury: "mercury", indexa_capital: "indexa_capital" }
